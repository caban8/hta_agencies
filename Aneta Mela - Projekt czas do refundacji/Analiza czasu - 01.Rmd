...
pacman::p_load(rstatix, readxl, tidyverse, lme4, modelr, DT, boot, future, furrr)
...
- Logarithmic transformation was applied to improve the distribution of errors and to allow for a linear relationship
- Outliers were removed to achieve full normality of the errors
- Bootstrapping was used to provide robust standard errors given the 
...
# Run bootstrap without parallel computing
set.seed(123) 
boot_result <- boot(
  df_filtered, 
  fun_boot, 
