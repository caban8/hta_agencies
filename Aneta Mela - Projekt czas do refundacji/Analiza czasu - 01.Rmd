...
form <- formula(log(dni_do_rekomendacji) ~ Kraj + Obszar_terapeutyczny + Year + (1|ID))
...
hist_resid(best_fit2)

```


```{r}
homoscedasticity_plot(best_fit2)
...
emm <- emmeans(best_fit2, pairwise ~ Kraj, type = "response")
